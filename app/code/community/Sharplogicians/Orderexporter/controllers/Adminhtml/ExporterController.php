...
class Sharplogicians_Orderexporter_Adminhtml_ExporterController extends Mage_Adminhtml_Controller_Action
{
	...
	public function exportLogAction()
	{
	  ...
	  $this->_prepareDownloadResponse($file, file_get_contents(Mage::getBaseDir('var') .'/sharplogicians_log/exporter/'.$file));
	}
}