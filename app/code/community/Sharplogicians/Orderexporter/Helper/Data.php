...
class Sharplogicians_Orderexporter_Helper_Data extends Mage_Core_Helper_Abstract
{
   public $error_file = '';
   
    public function __construct()
    {
		$this->error_file = Mage::getBaseDir('var') .'/sharplogicains_log/exporter/order_exception_log.htm';
